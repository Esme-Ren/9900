...
from .views import (
    ...
    LogSearchHistoryView,
    LogPageActivityView,
    LogSDGFormActivityView,
    LogBrowserActivityView,
...
urlpatterns = [
    ...
    path("sdg-plans/count/", AdminGetSDGPlansCountView.as_view(), name="sdgPlansCount"),

    # User Activity Tracking URLs
    path("log/search/", LogSearchHistoryView.as_view(), name="logSearchHistory"),
    path("log/page-activity/", LogPageActivityView.as_view(), name="logPageActivity"),
    path("log/form-activity/", LogSDGFormActivityView.as_view(), name="logFormActivity"),
    path("log/browser-activity/", LogBrowserActivityView.as_view(), name="logBrowserActivity"),
    path("user/activity-analytics/", UserActivityAnalyticsView.as_view(), name="userActivityAnalytics"),
    path("user/search-history/", UserSearchHistoryView.as_view(), name="userSearchHistory"),
]
